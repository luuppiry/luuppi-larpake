...
internal static class ConditionedLoggerExtensions
{
    ...
    {
        return value > 0 ? new(logger) : ConditionedLogger<T>.False;
    }
    ...
    {
        return value is null ? new(logger) : ConditionedLogger<T>.False;
    }
    
    internal static ConditionedLogger<T> IfTrue<T>(this ILogger<T> logger, bool value)
    {
        return value is true ? new(logger) : ConditionedLogger<T>.False;
    }
    
    internal static ConditionedLogger<T> IfFalse<T>(this ILogger<T> logger, bool value)
    {
        return value is false ? new(logger) : ConditionedLogger<T>.False;
    }
}
...
internal class ConditionedLogger<T>
{
    ...
    internal static readonly ConditionedLogger<T> False = new FalseLogger<T>();
    ...
    public ConditionedLogger<T> IfPositive(int value) => value > 0 ? this : False;
    public ConditionedLogger<T> IfNegative(int value) => value < 0 ? this : False;
    public ConditionedLogger<T> IfZero(int value) => value is 0 ? this : False;
    public ConditionedLogger<T> IfNull<TParam>(TParam value) => value is 0 ? this : False;
    public ConditionedLogger<T> IsTrue(bool value) => value is true ? this : False;
    public ConditionedLogger<T> IsFalse(bool value) => value is false ? this : False;
